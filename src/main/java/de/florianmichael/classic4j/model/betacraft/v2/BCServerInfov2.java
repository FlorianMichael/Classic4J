...
package de.florianmichael.classic4j.model.betacraft.v2;
 ...
 */
public record BCServerInfov2(String name, String description, String _icon, @SerializedName("is_public") boolean isPublic,
                             @SerializedName("online_players") int playerCount, @SerializedName("player_names") String _playerNames, @SerializedName("max_players") int playerLimit,
                             ...
                             @SerializedName("version_category") BCVersionCategory versionCategory, @SerializedName("software_name") String softwareName, @SerializedName("software_version") String softwareVersion,
